...
public:
    ...
    void assignTerminalToProject(TerminalDisplay *terminal, Project *project);
    void activateNextProject();
    void activatePreviousProject();
    void activateProjectByIndex(int index);
...
private:
    ...
    QHash<TerminalDisplay *, QPointer<Project>> _terminalToProject;
};
